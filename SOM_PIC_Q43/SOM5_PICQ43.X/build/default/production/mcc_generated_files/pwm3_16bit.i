# 1 "mcc_generated_files/pwm3_16bit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/pwm3_16bit.c" 2
# 51 "mcc_generated_files/pwm3_16bit.c"
...
# 51 "mcc_generated_files/pwm3_16bit.c" 2

# 1 "mcc_generated_files/pwm3_16bit.h" 1
# 55 "mcc_generated_files/pwm3_16bit.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\c99\\stdbool.h" 1 3
# 55 "mcc_generated_files/pwm3_16bit.h" 2
...
# 52 "mcc_generated_files/pwm3_16bit.c" 2




static void (*PWM3_16BIT_Slice1Output1_InterruptHandler)(void);
static void (*PWM3_16BIT_Slice1Output2_InterruptHandler)(void);
static void (*PWM3_16BIT_Period_InterruptHandler)(void);
...
void PWM3_16BIT_PWMI_ISR(void)
{
    ...
    {
        PWM3GIRbits.S1P1IF = 0;
        if(PWM3_16BIT_Slice1Output1_InterruptHandler != ((void*)0))
            PWM3_16BIT_Slice1Output1_InterruptHandler();
    }
    else if((PWM3GIEbits.S1P2IE == 1) && (PWM3GIRbits.S1P2IF == 1))
    {
        PWM3GIRbits.S1P2IF = 0;
        if(PWM3_16BIT_Slice1Output2_InterruptHandler != ((void*)0))
...
{
    PIR7bits.PWM3PIF = 0;
    if(PWM3_16BIT_Period_InterruptHandler != ((void*)0))
