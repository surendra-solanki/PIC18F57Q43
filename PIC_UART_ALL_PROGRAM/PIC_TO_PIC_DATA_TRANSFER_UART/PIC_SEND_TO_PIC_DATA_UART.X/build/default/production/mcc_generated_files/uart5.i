...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/uart5.c" 2
# 50 "mcc_generated_files/uart5.c"
...
# 57 "mcc_generated_files/uart5.h" 2
# 75 "mcc_generated_files/uart5.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
_Bool UART5_is_rx_ready(void)
{
    return (_Bool)(PIR13bits.U5RXIF);
}

_Bool UART5_is_tx_ready(void)
{
    return (_Bool)(PIR13bits.U5TXIF && U5CON0bits.TXEN);
}
